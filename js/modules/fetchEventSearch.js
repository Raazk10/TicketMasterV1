...
const baseUrl = `https://app.ticketmaster.com/discovery/v2/events.json?&apikey=${apiKey}&locale=*&keyword=&city=`;

export default async function fetchEventSearch(cityName) {
